...
class Caroustack {
  ...
  endScroll(event) {
    ...
    const itemClassElement = document.createElement("div");
    itemClassElement.className = "item";
    itemClassElement.key = "endSlide";

    containerClassElement.appendChild(itemClassElement);

    const cardClassElement = document.createElement("div");
    cardClassElement.className = "card";
    cardClassElement.key = "endSlide";
    itemClassElement.appendChild(cardClassElement);
    ...
    cardClassElement.querySelector(".cardImage").src = "./endSlideImage.png";
    cardClassElement.querySelector(".cardImage").alt = "endSlideImage";
    cardClassElement.querySelector(
      ".cardText"
    ).innerText = `That's it, for today!`;
    cardClassElement.querySelector(
      ".cardTitle"
    ).innerText = `You have seen it all!`;
